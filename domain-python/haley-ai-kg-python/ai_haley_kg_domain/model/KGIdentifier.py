...
class KGIdentifier(VITAL_Node):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/haley-ai-kg#hasKGIdentifierPrimaryID', 'prop_class': StringProperty}, 
        {'uri': 'http://vital.ai/ontology/haley-ai-kg#hasKGIdentifierPrimaryURI', 'prop_class': URIProperty}, 
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + KGIdentifier._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/haley-ai-kg#KGIdentifier'
