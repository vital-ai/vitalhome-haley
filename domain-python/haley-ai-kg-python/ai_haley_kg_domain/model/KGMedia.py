...
class KGMedia(KGNode):
    _allowed_properties = [
        ...
        {'uri': 'http://vital.ai/ontology/haley-ai-kg#hasKGMediaEncoding', 'prop_class': StringProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + KGMedia._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/haley-ai-kg#KGMedia'
