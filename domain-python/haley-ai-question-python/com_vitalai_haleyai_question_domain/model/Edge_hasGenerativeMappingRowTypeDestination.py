...
class Edge_hasGenerativeMappingRowTypeDestination(VITAL_PeerEdge):
    _allowed_properties = [
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + Edge_hasGenerativeMappingRowTypeDestination._allowed_properties
