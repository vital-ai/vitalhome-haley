...
class Edge_hasInteractionFlowStepActionInstance(VITAL_PeerEdge):
    _allowed_properties = [
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + Edge_hasInteractionFlowStepActionInstance._allowed_properties
