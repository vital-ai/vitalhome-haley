...
class Edge_hasLongAnswerOptionValueDependency(VITAL_PeerEdge):
    _allowed_properties = [
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + Edge_hasLongAnswerOptionValueDependency._allowed_properties
