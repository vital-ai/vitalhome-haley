...
class Edge_hasSelectedPredictionModel(VITAL_TaxonomyEdge):
    _allowed_properties = [
        {'uri': 'http://vital.ai/ontology/haley-ai-ml#hasSelectedPredictionModelName', 'prop_class': StringProperty}, 
