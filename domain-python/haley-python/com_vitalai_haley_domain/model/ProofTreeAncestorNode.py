...
class ProofTreeAncestorNode(ProofTreeNode):
    _allowed_properties = [
    ...
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + ProofTreeAncestorNode._allowed_properties

    @classmethod
    def get_class_uri(cls) -> str:
        return 'http://vital.ai/ontology/haley#ProofTreeAncestorNode'
