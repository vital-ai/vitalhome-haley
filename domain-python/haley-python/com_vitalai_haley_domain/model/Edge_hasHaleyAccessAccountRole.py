...
class Edge_hasHaleyAccessAccountRole(VITAL_PeerEdge):
    _allowed_properties = [
        {'uri': 'http://vital.ai/ontology/haley#hasAccessRoleScopeAccountURI', 'prop_class': URIProperty}, 
        ...
        {'uri': 'http://vital.ai/ontology/haley#hasAccessRoleScopeURI', 'prop_class': URIProperty}, 
    ]

    @classmethod
    def get_allowed_properties(cls):
        return super().get_allowed_properties() + Edge_hasHaleyAccessAccountRole._allowed_properties
